...
<!--chapter:end:ae-for-scRNA-seq-data.Rmd-->
...
<!--chapter:end:automatedCellType.Rmd-->


## Batch effect correction {#batch-effect-correction-2}
...
<!--chapter:end:batch-effect-correction-2.Rmd-->



### Batch effect correction {#batch-effect-correction}

<!--chapter:end:batch-effect-correction.Rmd-->
...
<!--chapter:end:bermuda.Rmd-->


## Biological function prediction {#biologicalFunctionPrediction}
...
<!--chapter:end:biologicalFunctionPrediction.Rmd-->



### Clustering {#clustering}

<!--chapter:end:clustering.Rmd-->
...
<!--chapter:end:DeepImpute.Rmd-->



### DESC: batch correction based on clustering {#desc}

<!--chapter:end:desc.Rmd-->
...
<!--chapter:end:digitalDLSorter.Rmd-->


### Dimension reduction by AEs with gene-interaction constrained architecture  {#dimension-reduction-by-aes}
...
<!--chapter:end:dimension-reduction-by-aes.Rmd-->


## Dimension reduction, latent representation, clustering, and data augmentation {#dimension-reduction}
...
<!--chapter:end:dimension-reduction.Rmd-->


## Doublet Classification  {#doubletClassification}
...
<!--chapter:end:doubletClassification.Rmd-->



## Evaluation methods {#EvalMethod}
...
<!--chapter:end:imputation-2.Rmd-->



### Imputation {#imputation}

<!--chapter:end:imputation.Rmd-->
...
<!--chapter:end:multi-functional.Rmd-->
...
<!--chapter:end:overview-of-common-dl-models-for-scRNA-seq-analysis.Rmd-->
...
<!--chapter:end:overview-of-datasets-and-evaluation-metrics.Rmd-->
...
<!--chapter:end:overview-of-scRNA-seq-pipeline.Rmd-->



### SAUCIE {#saucie}

<!--chapter:end:saucie.Rmd-->



### SAVER-X: single-cell analysis via expression recovery harnessing external data {#saver-x}

<!--chapter:end:saver-x.Rmd-->
...
<!--chapter:end:scDGN.Rmd-->


### scGen, a generative model to predict perturbation response of single cells across cell types {#scGen}
...
<!--chapter:end:scIGANs.Rmd-->



### scScope {#scScope}

<!--chapter:end:scScope.Rmd-->


### cscGAN: Conditional single-cell generative adversarial neural networks {#scsGAN}
...
<!--chapter:end:survey-of-dl-models-for-scRNA-seq-analysis.Rmd-->
...
<!--chapter:end:vae-for-scRNA-seq-data.Rmd-->


### VASC: VAE for scRNA-seq  {#VASC}
