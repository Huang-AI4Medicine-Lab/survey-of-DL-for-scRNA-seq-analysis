...
EvaluationMethod=c("Pseudobulk RNA-seq",
                   ...
                   "Entropy of accuracy, Hacc [@RN44]",
                   "Entropy of purity, Hpur [@RN44]",
                   "Entropy of mixing [@RN84]",
                   "Mutual Information (MI) [@RN103]",
                   "Normalized Mutual Information (NMI) [165, BIB not found]",
                   "Kullback–Leibler (KL) divergence [166, BIB not found]",
                   "Jaccard Index",
                   "Fowlkes-Mallows Index for two clustering algorithms (FM)",
                   "Rand index (RI)",
                   "Adjusted Rand index (ARI) [@RN107]",
                   "Silhouette index",
                   "Maximum Mean Discrepancy (MMD) [@RN185]",
                   "k-Nearest neighbor batch-effect test (kBET) [@RN105]",
                   "Local Inverse Simpson’s Index (LISI) [@RN74]",
                   "Homogeneity",
                   "Completeness",
                   "V-Measure [169, BIB not found]",
                   "Precision, recall",
                   "Accuracy",
                   "F1-score",
                   "AUC, RUROC"
